...
import { makeAcpCommandCatalog } from "./AcpCommandCatalog.ts";

/** Session command catalogs stay scoped to their workspace across health refreshes. */
export const makeCursorCommandCatalog = (provider: ServerProviderShape) =>
  makeAcpCommandCatalog(provider, (commands, skills) => {
