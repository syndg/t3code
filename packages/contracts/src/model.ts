...
/** Keep OMP's configured model until the user selects a specific one. */
export const OMP_DEFAULT_MODEL = "omp-default";
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [ProviderDriverKind.make("omp")]: OMP_DEFAULT_MODEL,
